        ...
        <>
            <div className="container-sobre_mi">
                <div className="row">
                    ...
                    <div className="sobre_mi_4 col-12 p-4 d-flex align-items-center">Si querés saber mas sobre mi podes ver mi <a href="https://www.linkedin.com/in/francozvilling/">Linkedin</a></div>
                </div>
            </div>
        </>
    )
